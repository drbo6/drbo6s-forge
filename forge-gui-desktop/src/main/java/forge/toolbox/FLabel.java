        ...
        if (b0.bldSelectable || b0.bldHoverable) {
            ...
            this.addKeyListener(new KeyAdapter() {
                ...
                public void keyPressed(final KeyEvent e) {
                    if (e.getKeyChar() == ' ' || e.getKeyCode() == 10 || e.getKeyCode() == KeyEvent.VK_ENTER) { _doMouseAction(); } // This looks like another case where we took things too far by adding SPACE as an option.
                }
            });
